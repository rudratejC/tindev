                ...
                <div className="completeTweet">
                  <div className="who">
                    ...
                    <div className="accWhen">
                      {`${e.attributes.Acc.slice(
                        0,
                        4
                      )}...${e.attributes.Acc.slice(38)} · 
                  ...
                  <div className="tweetContent">
                    {e.attributes.projectTxt}
                    {e.attributes.img && (
                      <img src={e.attributes.img} className="tweetImg"></img>
                    )}
                  </div>
